    ...
    <div className="max-w-3xl mx-auto px-6 md:px-12 py-32">
            ...
            <div key={step} className="flex items-center">
              <div
                className={`w-2 h-2 rounded-full transition-all ${
                  currentStep === step
                    ? "bg-primary w-8"
                    : index < ["welcome", "email", "handle", "demo", "complete"].indexOf(currentStep)
                    ? "bg-primary/50" :"bg-white/10"
                }`}
              />
      ...
      {currentStep === "complete" && (
        <div className="text-center fade-in-up">
          ...
          <p className="text-lg text-zinc-400 font-light mb-12 max-w-2xl mx-auto">
            Welcome to LowKey, @{handle}. Ready to start your journey toward thoughtful
            engagement?
          </p>
