    ...
    <section className="py-32 px-6 md:px-12 bg-background border-b border-white/[0.08]">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-12 items-start">
          <div className="relative w-full md:w-1/3 aspect-[3/4] overflow-hidden grayscale hover:grayscale-0 transition-all duration-700">
            <img
              src="/assets/images/founder.jpg"
              alt="Rahul Pandit, Founder of LowKey"
              className="object-cover w-full h-full"
            />
          </div>
          <div className="space-y-8 text-lg text-zinc-400 font-light leading-relaxed md:w-2/3">
            <p>
