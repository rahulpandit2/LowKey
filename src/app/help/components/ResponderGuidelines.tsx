      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-500">"You should have..." or "Why didn't you..."</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="border border-white/[0.05] p-8 rounded-sm bg-card">
            <div className="mb-6">
              <p className="text-xs uppercase tracking-widest text-zinc-600 mb-2">Example Help Post</p>
            ...
            <div className="space-y-6 border-t border-white/[0.08] pt-6">
              ...
              <div>
                <p className="text-xs uppercase tracking-widest text-primary mb-2">Practical Step</p>
                <p className="text-sm text-zinc-300">
              ...
              <div>
                <p className="text-xs uppercase tracking-widest text-primary mb-2">Gentle Question</p>
                <p className="text-sm text-zinc-300">
