            ...
            <div className="space-y-4">
                  ...
                  <div
                    className={`w-5 h-5 border rounded-sm mt-0.5 flex items-center justify-center transition-colors ${
                      settings.emailDigest
                        ? "border-primary bg-primary" :"border-zinc-600 group-hover:border-white"
                    }`}
                  >
                    {settings.emailDigest && <Icon name="CheckIcon" size={12} className="text-white" />}
                  </div>
              ...
              <div className="p-6 border border-white/[0.05] rounded-sm bg-card">
                <label className="flex items-start gap-4 cursor-pointer group">
                  ...
                  >
                    {settings.emailReplies && <Icon name="CheckIcon" size={12} className="text-white" />}
                  </div>
                  <div className="flex-1">
              ...
              <div className="p-6 border border-white/[0.05] rounded-sm bg-card">
                <label className="flex items-start gap-4 cursor-pointer group">
                  ...
                  >
                    {settings.emailMentions && <Icon name="CheckIcon" size={12} className="text-white" />}
                  </div>
                  <div className="flex-1">
            ...
            <div className="space-y-4">
              <div className="p-6 border border-white/[0.05] rounded-sm bg-card">
                <label className="flex items-start gap-4 cursor-pointer group">
                  ...
                  >
                    {settings.inAppReplies && <Icon name="CheckIcon" size={12} className="text-white" />}
                  </div>
                  <div className="flex-1">
              ...
              <div className="p-6 border border-white/[0.05] rounded-sm bg-card">
                <label className="flex items-start gap-4 cursor-pointer group">
                  ...
                  >
                    {settings.inAppMentions && <Icon name="CheckIcon" size={12} className="text-white" />}
                  </div>
                  <div className="flex-1">
                    <h4 className="text-white font-medium mb-1">Mentions</h4>
                    <p className="text-sm text-zinc-500">
